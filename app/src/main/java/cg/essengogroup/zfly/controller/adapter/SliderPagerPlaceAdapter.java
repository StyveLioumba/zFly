...
public class SliderPagerPlaceAdapter extends PagerAdapter {

    private Context mContext;
    private List<Gallerie> mList;

    public SliderPagerPlaceAdapter(Context mContext, List<Gallerie> mList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        if (inflater != null) {
            sliderLayout = inflater.inflate(R.layout.item_img_galerie_place,null);
        }
